...
def _command_detection_variants(command: str):
    ...
    # untouched on every other command. This lives in the OUTER function
    # because it is the only scope that still holds the raw `command`;
    # `_detection_variants_for_text` only ever sees normalized text.
