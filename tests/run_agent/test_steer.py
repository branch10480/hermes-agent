...
class TestActiveTurnRedirectCheckpoint:
    ...
    def test_checkpoint_omits_reasoning_label_when_nothing_visible(self):
        ...
        # The durable row stays empty on purpose; that it never re-heals on the
        # wire is covered by TestEmptyHiddenAssistantRehealRegression below,
        # which asserts the api_content projection the sanitizer actually sees.
